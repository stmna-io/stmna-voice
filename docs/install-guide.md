# STMNA_Voice Install Guide

> By the end of this guide, you will have the STMNA_Voice transcription pipeline running: record audio on your phone or Linux desktop, get back a structured transcription processed by a local LLM.
>
...
| A client device | Android phone ([STMNA_Voice Mobile](https://github.com/stmna-io/stmna-voice-mobile)) or Linux desktop ([Linux guide](linux-guide.md)) |
...
**Android:** Install the [STMNA_Voice Mobile](https://github.com/stmna-io/stmna-voice-mobile) app, connect it to your Desk, and record a short voice note.
...
- [STMNA_Voice Mobile](https://github.com/stmna-io/stmna-voice-mobile): install and configure the Android app
