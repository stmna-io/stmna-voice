# STMNA_Voice Linux Client Guide
...
|-------------|----------------|
| STMNA_Voice backend running | [Install guide](install-guide.md) |
...
# Public: https://YOURDOMAIN.COM/v1/audio/transcriptions
STMNA_VOICE_ENDPOINT="https://YOURDOMAIN.COM/v1/audio/transcriptions"
EOF
```

> **Required:** Replace the token and endpoint with your actual values from the STMNA_Voice backend setup.

Alternatively, set environment variables instead of using the config file:

```bash
export STMNA_VOICE_TOKEN="your-token-here"
export STMNA_VOICE_ENDPOINT="https://YOURDOMAIN.COM/v1/audio/transcriptions"
```
...
2. Add: Name `STMNA_Voice`, Command `/home/YOUR_USER/bin/voice.sh`
...
2. **Second press:** Stops recording, uploads the WAV file to your STMNA_Voice endpoint via HTTP POST
